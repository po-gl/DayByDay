...
struct WavePath: Shape {
  func path(in rect: CGRect) -> Path {
    ...
    path.addQuadCurve(
      to: CGPoint(x: rect.midX, y: rect.midY), controlPoint: CGPoint(x: rect.minX, y: rect.midY))

    path.addQuadCurve(
      to: CGPoint(x: curveMaxX, y: curveMinY), controlPoint: CGPoint(x: rect.maxX, y: rect.midY))
