  ...
  private func Active() -> some View {
    Group {
      Circle()
        ...
        .offset(x: moving ? -200 : -100, y: moving ? -90 : -70)
      ...
      Circle()
        .scaleEffect(0.6)
        .offset(x: moving ? -100 : -50, y: moving ? -50 : -100)
      ...
      Circle()
        .scaleEffect(0.4)
        .offset(x: moving ? -30 : -30, y: moving ? -100 : -170)
  ...
  private func Creative() -> some View {
    Group {
      Circle()
        ...
        .rotationEffect(
          .degrees(moving ? 360 : 0),
          anchor: .init(x: UnitPoint.center.x - 0.1, y: UnitPoint.center.y + 0.1)
        )
...
extension View {
  public func blurAndBrighten(radius: CGFloat, _ brightness: CGFloat, _ saturation: CGFloat)
    -> some View
  {
