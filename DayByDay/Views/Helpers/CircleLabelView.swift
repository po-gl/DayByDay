...
struct CircleLabelView_Previews: PreviewProvider {
  static var previews: some View {
    CircleLabelView(
      radius: 150, kerning: 4, size: CGSize(width: 400, height: 400), startAngle: .bottom,
      text: "Activity"
    )
    .font(.system(size: 20, weight: .semibold, design: .monospaced))
    CircleLabelView(
      radius: 150, kerning: 4, size: CGSize(width: 400, height: 400),
      text: "send me to the mountains, let me go free forever"
    )
    .font(.system(size: 20, weight: .semibold, design: .monospaced))
  }
}
