...
struct PastView: View {
  ...
  private func WigglyBars() -> some View {
    HStack(spacing: 25) {
      ...
      WigglyBar(
        category: .productive, width: ButtonCluster.lowerBoundDiameter, height: PastView.height)
      WigglyBar(
        category: .creative, width: ButtonCluster.lowerBoundDiameter, height: PastView.height)
    }
