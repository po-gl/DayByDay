...
class DaysCalendarViewController: UIViewController {
  ...
  private var allDaysDict = [Date: DayMO]()
  ...
  override func viewDidLoad() {
    ...
    calendarView.daySelectionHandler = { [weak self] day in
      ...
      let vc = DaysCalendarSelectedViewController(
        date: date, day: dayMO,
        onDismiss: {
          self.loadDaysData()
  ...
  func makeContent() -> CalendarViewContent {
    ...
    let monthsLayout = MonthsLayout.vertical(
      options: VerticalMonthsLayoutOptions(
        pinDaysOfWeekToTop: false, alwaysShowCompleteBoundaryMonths: false))
...
private var justYearFormatter: DateFormatter = {
  let formatter = DateFormatter()
