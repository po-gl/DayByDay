...
extension LinearGradient {
  init(for category: StatusCategory) {
    ...
    case .active:
      self.init(
        stops: [
          .init(color: Color(hex: 0xE69F1E), location: 0.0),
    ...
    case .creative:
      self.init(
        stops: [
          .init(color: Color(hex: 0xFCEBD6), location: 0.0),
    ...
    case .productive:
      self.init(
        stops: [
          .init(color: Color(hex: 0xC62379), location: 0.0),
  ...
  init(forSimple category: StatusCategory) {
    switch category {
    case .active:
      self.init(
        stops: [
          ...
          .init(color: Color(hex: 0xB04386), location: 1.0),
        ],
    ...
    case .creative:
      self.init(
        stops: [
          .init(color: Color(hex: 0xBAE1E5), location: -0.2),
          .init(color: Color(hex: 0xBE59D5), location: 0.5),
    ...
    case .productive:
      self.init(
        stops: [
          .init(color: Color(hex: 0xFF7676), location: 0.0),
          .init(color: Color(hex: 0x97D327), location: 0.5),
          .init(color: Color(hex: 0xFFF074), location: 1.1),
        ],
